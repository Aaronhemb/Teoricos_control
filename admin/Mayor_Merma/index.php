...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px;" href="index.php">Mayor Merma</a>
  <a class="nav-item nav-link active" href="../Extras/index.php">Extras</a>
  <a class="nav-item nav-link active"  href="../view/view0.php">Reportes</a>
...
<div class="jumbotron text-center">
  <h1>  ADMINISTRADOR MAYOR MERMA TIENDA 128 SAN ANGEL </h1>
</div>
...
<div class="container mt-5" style=" margin-left: -6px !important;">
    <div class="col-12">



    <div class="row"  style="    margin-right: -198px !important;">
<div class="col-30 grid-margin">
<div class="card">
<div class="card-body">
...
<form id="form2" name="form2" method="POST" action="index.php">
        ...
        if ($_POST["Gerente"] == '' AND $_POST['Division'] == '' AND $_POST['Status'] == '' AND $_POST['Proveedor'] == '' AND $_POST['buscafechahasta'] == ''AND $_POST['buscapreciodesde'] == '' AND $_POST['buscapreciohasta'] == ''){
...
<a href="descarga/data.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-export"></span> Exportar Tabla como CSV</a>
<div class="table-responsive">
        <table class="table">
                ...
                <?php While($rowSql = $sql->fetch_assoc()) {   ?>
                        ...
                        <td style="text-align: center;"><?php echo $rowSql["PiezasI"]; ?></td>

                        <td style="text-align: center;"><?php echo $rowSql["Fecha4"]; ?></td>
                        <td style=" text-align: center;"><?php echo $rowSql["Status"]; ?></td>
                        <td style="text-align: center;"><?php echo $rowSql["Compromiso"]; ?></td>
                        <td> <a href="modificar.php?id=<?php echo $rowSql['id']; ?>">Modificar</a></td>
                        <td> <a href="eliminar.php?id=<?php echo $rowSql['id']; ?>">Eliminar</a></td>
                        </tr>
