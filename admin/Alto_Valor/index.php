...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px;" href="index.php">Alto Valor</a>
...
<div class="jumbotron text-center">
  <h1>  ADMINISTRADOR ALTO VALOR TIENDA 128 SAN ANGEL </h1>
</div>
