...
<body oncontextmenu="return false" onkeydown="return false">
	...
	<div class="navbar-nav">
	  ...
	  <a class="nav-item nav-link active"  style="background-color: gold; border-radius: 26px 23px 20px 24px;" href="index.php">CALENDARIO</a>
	...
	<div class="jumbotron text-center">
	  <h1>  CALENDARIO DE TEORICOS TIENDA 128 SAN ANGEL </h1>
...
<div class="recordar" style="    margin: 86px 17px 28px 241px;">
	<p>Recordatorio: <br> 2 semanas son para finalizar teoricos de Alto Valor </p>
	<p> 3 semanas son para finalizar teoricos de Mayor Merma </p>
	<p>  4 semanas son para finalizar teoricos  Extras </p>
</div>
