...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" href="modificar.php">REPORTES</a>
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px; margin: -3px;" href="view.php">VIEW</a>

</div>
</div>
</nav>
<div class="jumbotron text-center">
  <h1> AJUSTES Y REPORTES TIENDA 128 SAN ANGEL </h1>
</div>
