...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px; margin: -3px;" href="index0.php">ALTO VALOR</a>
...
<div class="jumbotron text-center">
  <h1>  TEORICOS ALTO VALOR TIENDA 128 SAN ANGEL </h1>
</div>
...
<form id="form2" name="form2" method="POST" action="index0.php">
