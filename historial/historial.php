...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px;" href="historial.php">HISTORICO</a>
...
<div class="jumbotron text-center">
  <h1>  HISTORICO TEORICOS TIENDA 128 SAN ANGEL </h1>
</div>
...
<form id="form2" name="form2" method="POST" action="historial.php">
        ...
        if ($_POST["Gerente"] == '' AND $_POST['Division'] == '' AND $_POST['Proveedor'] == '' AND $_POST['Fecha'] == '' AND $_POST['buscafechahasta'] == ''AND $_POST['buscapreciodesde'] == '' AND $_POST['buscapreciohasta'] == ''){
...
<a href="datahistorico.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-export"></span> Exportar Tabla como CSV</a>
