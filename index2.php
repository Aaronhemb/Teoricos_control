...
<div class="navbar-nav">
  ...
  <a class="nav-item nav-link active" style="    margin: -3px; display: flex;"  href="index0.php">ALTO VALOR</a>
  <a class="nav-item nav-link active" style="    margin: -3px; display: flex;"  href="index1.php">MAYOR MERMA</a>
  <a class="nav-item nav-link active" style="background-color: gold; border-radius: 26px 23px 20px 24px; margin: -3px;" href="index2.php">EXTRAS</a>
...
<div class="jumbotron text-center">
  <h1>  TEORICOS EXTRAS TIENDA 128 SAN ANGEL </h1>
</div>
